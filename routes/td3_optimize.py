...
td3_optimize_bp.add_url_rule('/api/td3-optimize/agents', 'get_trained_agents', get_trained_agents, methods=['GET'])
td3_optimize_bp.add_url_rule('/api/td3-optimize/agents/<model_name>', 'get_agent_detail', get_agent_detail, methods=['GET'])
td3_optimize_bp.add_url_rule('/api/td3-optimize/agents/<model_name>', 'delete_agent', delete_agent, methods=['DELETE'])
