...
# 从各个子模块导入路由函数
from .td3_optimize_routes import td3_optimize, td3_batch_optimize, get_td3_batch_status, get_performance_thresholds, update_performance_thresholds
...
td3_optimize_bp.add_url_rule('/api/td3-optimize/agents/<line_id>', 'get_trained_agents', get_trained_agents, methods=['GET'])
td3_optimize_bp.add_url_rule('/api/td3-optimize/agents/<line_id>/<model_name>', 'get_agent_detail', get_agent_detail, methods=['GET'])
td3_optimize_bp.add_url_rule('/api/td3-optimize/agents/<line_id>/<model_name>', 'delete_agent', delete_agent, methods=['DELETE'])
